...
namespace github
{
    public class ScrapeRequest : IDisposable
    {
        ...
        private static githubForm _form;
        ...
        public ScrapeRequest(string apiKey, bool showNodes, bool flightReturn, githubForm form, string departureAirport, string arrivalAirport, string departureDate, string arrivalDate, string domainValue, string flightDuration, int id, int maxPrice)
        {
            if (_form == null)
            {
                _form = form;
            ...
            if (_flightReturn)
            {
                RequestUrl = "https://github." + _domainValue + "/flight-search/" + departureAirport + "-" + arrivalAirport + "/" + departureDate + "/" + arrivalDate + "?fs=legdur=-" + _flightDuration;
            }
            else
            {
                RequestUrl = "https://github." + _domainValue + "/flight-search/" + departureAirport + "-" + arrivalAirport + "/" + departureDate + "/" + "?fs=legdur=-" + _flightDuration;
